    ...
    <div class="card__content">
        ...
        <div class="card__icons">
            <span class="card__likes__icon">
                {#if data.liked}
                    <button on:click={() => data.like()} class="material-symbols-rounded filled red">
                        favorite
                    </button>
                {:else}
                    <button on:click={() => data.like()} class="material-symbols-rounded">
                        favorite
                    </button>
                {/if}
            </span>
            <span class="card__saved__icon">
                {#if data.saved}
                    <button on:click={() => data.save()} class="material-symbols-rounded green">
                        playlist_add_check
                    </button>
                {:else}
                    <button on:click={() => data.save()} class="material-symbols-rounded">
                        playlist_add
                    </button>
                {/if}
            </span>
